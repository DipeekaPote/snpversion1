              ...
              <Box mt={2}>
                <TableContainer component={Paper}>
                  <Table>
                              ...
                              <TableCell colSpan={5}>
                                <Box>
                                  ...
                                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                                    <Typography
                                      sx={{ fontWeight: 'bold', fontSize: '15px', display: 'inline-block', color: '#1976d2' }}
                                    ...
                                    <IconButton
                                      ...
                                      size="small"
                                      onClick={(e) => handleMenuClick(e, _id, contactName)}
                                    >
                                      <MoreVertIcon />
                                    </IconButton>
                                  </Box>
                    ...
                    {/* Description Modal */}
                    <Dialog open={descriptionModalOpen} onClose={handleDescriptionCancel} aria-labelledby="form-dialog-title"
                      PaperProps={{
